  ...
  return (
    <>
      ...
      <aside
        ...
        className={`fixed inset-y-0 right-0 z-50 w-full max-w-sm overflow-y-auto bg-white p-6 shadow-2xl transition duration-300 sm:max-w-md ${
      ...
      >
        <div className="mb-8 flex items-center justify-between gap-4">
          ...
          <button
            ...
            aria-label="Close cart drawer"
            onClick={onClose}
            className="grid size-10 place-items-center rounded-full border border-[#ead8d1] text-[#87635a] transition hover:border-[#c73b0f] hover:text-[#c73b0f] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#c73b0f]"
          >
